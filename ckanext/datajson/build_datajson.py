    ...
    def make_datajson_export_entry(package):
        ...
        if date:
            ...
            harvest_object = model.Session.query(HarvestObject) \
                      ...
                      .first()
            accessLevel =  extra(package, "Access Level", default="public")
            accrualPeriodicity = JsonExportBuilder.get_accrual_periodicity_spatial(extra(package,"Frequency Of Update"))
            ...
            log.warn("language = %s %s",language,JsonExportBuilder.strip_if_string(extra(package,'Metadata Language',"")))
